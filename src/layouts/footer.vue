<template>
	<div class="foot-btn">
		<ul>
			<router-link to="/home" tag="li" active-class="home-active" class="home"><a href="javascript:;"></a></router-link>
			<router-link to="/field" tag="li" active-class="write-active" class="write"><a href="javascript:;"></a></router-link>
			<router-link to="/user" tag="li" active-class="my-active" class="my"><a href="javascript:;"></a></router-link>
		</ul>
	</div>
</template>
